...
SCREENS: dict[str, dict] = {
    ...
    "owner-hub":       {"file": "island-junk-owner-hub-v54.html",   "keys": _HUB_REFS + _HR_REFS + ["ij_usage_v1", "ij_checklists_v1", "ij_po_needed_v1", "ij_po_seeded_v1"], "bridge": "owner-hub-bridge.js"},
    "manager-hub":     {"file": "island-junk-management-hub-v83.html", "keys": _HUB_REFS + _HR_REFS + ["ij_reviews_v1", "ij_usage_v1", "ij_po_needed_v1"], "bridge": None},
