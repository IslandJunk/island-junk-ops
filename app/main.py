...
SCREENS: dict[str, dict] = {
    ...
    "residential-calculator": {"file": "CREW-residential-calculator-v25.html", "keys": ["ij_rates_v1", "ij_employees_v1", "ij_jobs_v1", "ij_reviews_v1", "ij_usage_v1"], "bridge": None},
    "commercial-form": {"file": "CREW-commercial-form-v22.html", "keys": ["ij_rates_v1", "ij_employees_v1", "ij_jobs_v1", "ij_usage_v1"], "bridge": None},
    "owner-hub":       {"file": "island-junk-owner-hub-v54.html",   "keys": _HUB_REFS + _HR_REFS + ["ij_usage_v1"], "bridge": "owner-hub-bridge.js"},
    "manager-hub":     {"file": "island-junk-management-hub-v83.html", "keys": _HUB_REFS + _HR_REFS + ["ij_reviews_v1", "ij_usage_v1"], "bridge": None},
    "truck-hub":       {"file": "island-junk-truck-hub-v54.html",   "keys": ["ij_employees_v1", "ij_fleet_v1", "ij_fixes_v1", "ij_daynotes_v1", "ij_usage_v1"], "bridge": None},
