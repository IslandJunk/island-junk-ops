...
SCREENS: dict[str, dict] = {
    ...
    "truck-hub":       {"file": "island-junk-truck-hub-v54.html",   "keys": ["ij_employees_v1", "ij_fleet_v1"], "bridge": None},
    ...
    "maintenance-hub": {"file": "island-junk-maintenance-hub-v12.html", "keys": ["ij_fleet_v1"], "bridge": None},
    ...
    "reminders":       {"file": "island-junk-reminders-v1.html",   "keys": [], "bridge": None},
